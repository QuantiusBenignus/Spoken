...
---
*(This repository expands on the older [NoteWhispers](https://github.com/QuantiusBenignus/NoteWhispers) by bringing new tools and functionality, such as recording Joplin to-do tasks with automatic alarms and the ability to handle multiple voice memos. Very much work in progress, but the zsh version of td is ahead of the bash version in functionality.)*
